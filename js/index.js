...
async function getCategories(){
    ...
    response = await response.json()
    // console.log(displayMeals(response) );
    $("#home").show();
...
function displayIngredients(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        // console.log(arr[i].strDescription.split(" ").slice(0,20).join(" "));
...
{/* <div class="col-md-3">
                <div onclick="getIngredientMeals('${arr[i].strIngredient}')" class="rounded-2 text-center ">
